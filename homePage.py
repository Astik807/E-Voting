...
def Home(root, frame1, frame2):
    ...
    # voter = Button(frame1, text="Voter Login", width=15, command = lambda: voter_ID=voter_ID.get(), password=password.get(): log_server(root, frame1, client_socket, voter_ID, password))
